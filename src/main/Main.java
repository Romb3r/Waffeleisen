...
public class Main {
	public static void main(String[] args) {
		...
		Motor motor = new Motor(Define_Hardware.iMotorSpeed, 
								Define_Hardware.iMotorRotationAngle * Define_Hardware.iMotorNumRotations);		// erzeuge Objekt der Klasse Motor. Eine Umdrehung * Anzahl Umdrehungen
